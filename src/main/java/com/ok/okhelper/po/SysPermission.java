...
public class SysPermission {
    ...
    public SysPermission(Long id, String menuCode, String menuName, String permissionCode, String permissionName, Date createTime, Date updateTime, String deleteStatus, Long operator) {
        this.id = id;
