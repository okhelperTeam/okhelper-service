...
public class SysUser {
    ...
    public SysUser(Long id, String userName, String userPassword, String passProblem, String passAnswer, String userNick, String userAvatar, String userPhone, String userEmail, String userSex, Date userBirthday, Date createTime, Date updateTime, String deleteStatus, Long operator) {
        this.id = id;
